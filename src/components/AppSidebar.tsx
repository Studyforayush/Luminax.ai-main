...
const navigationItems = [
  ...
  { titleKey: "nav.study", url: "/study", icon: BookOpen },
  { titleKey: "nav.progress", url: "/progress", icon: TrendingUp },
      ...
      <SidebarContent className="gradient-card border-r border-sidebar-border">
        ...
        <div className="p-4 border-b border-sidebar-border">
          <div className="flex items-center gap-2">
            ...
            {!isCollapsed && (
              <div>
                <h2 className="font-bold text-lg text-primary glow-primary">Luminax AI</h2>
