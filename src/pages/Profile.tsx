...
const Profile = () => {
  ...
  const handleViewAchievements = () => {
    ...
    // Could navigate to a detailed achievements page
  };

  const handleViewActivity = () => {
    console.log("Viewing detailed activity...");
  ...
  return (
    <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                ...
                <Badge variant="outline" className="cursor-pointer hover:bg-primary/10" onClick={handleViewCommunity}>JEE Legends Community</Badge>
            ...
            <div className="text-center">
              ...
              <div className="mt-2 cursor-pointer" onClick={handleViewLeaderboard}>
                <div className="text-lg font-semibold text-secondary hover:text-primary transition-colors">#10</div>
      ...
      <div className="grid md:grid-cols-4 gap-6">
        <Card className="gradient-card border-border/50 text-center cursor-pointer hover:shadow-lg transition-all duration-200" onClick={handleStartStudy}>
          <CardContent className="p-6">
        ...
        <Card className="gradient-card border-border/50 text-center cursor-pointer hover:shadow-lg transition-all duration-200" onClick={handleViewAchievements}>
          <CardContent className="p-6">
        ...
        <Card className="gradient-card border-border/50 text-center cursor-pointer hover:shadow-lg transition-all duration-200" onClick={handleViewProgress}>
          <CardContent className="p-6">
        ...
        <Card className="gradient-card border-border/50 text-center cursor-pointer hover:shadow-lg transition-all duration-200" onClick={handleViewActivity}>
          <CardContent className="p-6">
      ...
      <Card className="gradient-card border-border/50">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Button variant="outline" className="h-auto p-4 flex flex-col items-center gap-2" onClick={handleStartStudy}>
              <BookOpen className="w-6 h-6" />
              <span className="text-sm">Start Study</span>
            </Button>
