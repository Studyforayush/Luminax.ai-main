    ...
    <div className="p-6 space-y-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-4">
          Your{" "}
          <span className="gradient-primary bg-clip-text text-green-600 animate-pulse">
            Progress
          </span>
        </h1>
      ...
      <Card className="bg-white-900 border-white/100">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
        ...
        <CardContent>
          <div className="h-15 flex items-end justify-between gap-2">
            {[120, 80, 150, 200, 100, 180, 220].map((value, index) => (
              <div key={index} className="flex flex-col items-center gap-1 flex-1">
                ...
                ></div>
                <span className="text-xl font-bold text-green-600 border-b-2 border-white">
          ...
          <div className="mt-4 text-center">
            <p className="text-lg font-bold text-white">
              Total this week: <span className="text- font-bold text-lg">1,050 XP</span>
            </p> 
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="gradient-card border-border/50">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-3 bg-#2CFF05-400 rounded-lg border border-xp-white-50">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-green-800 font-bold">Complete 50 quizzes with 90%+ score</p>
              </div>
              <Badge className="bg-xp-gold text-white">+100 XP</Badge>
            </div>

            <div className="flex items-center gap-4 p-3 bg-white-400 rounded-lg border border-xp-white-50">
              <div className="w-10 h-10 bg-warning rounded-full flex items-center justify-center">
                <Flame className="w-5 h-5 text-white" />
              </div>
              <div className="flex-1">
                <p className="font-semibold">Week Warrior</p>
                <p className="text-sm text-green-800 font-bold">Maintain 7-day study streak</p>
              </div>
